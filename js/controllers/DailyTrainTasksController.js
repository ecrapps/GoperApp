GoperApp.controller('DailyTrainTasksController', ['$scope', '$http', '$mdDialog', 'TaskService', 'CommentService', '$element', '$timeout', '$log', 'ToastService', 'URL_TRAIN_API', 'IdSessionService',
	function ($scope, $http, $mdDialog, TaskService, CommentService, $element, $timeout, $log, ToastService, URL_TRAIN_API, IdSessionService) {
	    ...
	    */
	    ...
	    function getDailyTasks(idUser) {
	    	TaskService.getDailyTasks(idUser)
